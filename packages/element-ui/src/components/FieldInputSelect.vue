<template>
    <div class="_fd-field-input-select">
        <div class="fc-icons">
            <i class="fc-icon icon-group" @click.stop="copy"></i>
            <i v-if="!fieldReadonly" class="fc-icon icon-auto" @click="makeField"></i>
        </div>
...
<style>
._fd-field-input-select {
    width: 100%;
}
._fd-field-input-select > .fc-icons {
    position: absolute;
    right: 24px;
    top: 1px;
    z-index: 3;
...
._fd-field-input-select > .fc-icons > .fc-icon {
    color: #a8abb2;
    cursor: pointer;
    width: 20px;
    height: 24px;
...
._fd-field-input-select > .fc-icons > .fc-icon:hover {
    color: #2E73FF;
}

._fd-field-input-select .el-input-group__append {
    width: 25px;
    padding: 0;
    margin: 0;
    color: #606266;
